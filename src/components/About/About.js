...
const About = (props) => (
	<Section id='about'>
		...
		<InfoText>
			...
			sector, where I produced and managed a few small projects with excel, some
			of which I have since been able to develop further with the knowledge I
			have gained in javascript.
		</InfoText>
		<InfoText>
